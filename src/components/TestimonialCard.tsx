const TestimonialCard = () => {
  return (
    <>
      <div className="relative bg-white flex flex-shrink-0 w-[26rem] flex-col rounded-xl py-4 px-6 text-gray-700 shadow-none">
        <div className="relative mx-0 mt-4 flex items-center gap-4 overflow-hidden rounded-xl bg-transparent bg-clip-border pt-0 pb-8 text-gray-700 shadow-none">
          ...
          <div className="flex w-full flex-col gap-0.5">
            ...
            <p className="block font-sans text-base font-light leading-relaxed text-_green antialiased">
              Store link
            </p>
          </div>
        </div>
